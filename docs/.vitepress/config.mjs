    ...
    sidebar: [
      {
        ...
        items: [
          ...
          { text: '第一章：走進《馬勒第八》的 Vienna：一座城市，幾種互不相讓的未來', link: '/chapters/CORE_01_READER_DRAFT' },
          { text: '第二章：《浮士德》還沒寫完，為什麼已經先被唱出來？', link: '/chapters/CORE_02_READER_DRAFT' },
          { text: '第三章：讀懂 Mahler 選中的《Faust》：一個永遠不能停下來的人', link: '/chapters/CORE_03_READER_DRAFT' },
