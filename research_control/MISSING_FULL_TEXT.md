...
This file compares bibliographic references in `research_control_original/` with actual full-text files under `sources_raw/`. “Missing” means **not present in the local immutable evidence directory**. It does not mean that a work is unavailable online or through a library. URLs and availability labels below are inherited from the older notes and were not treated as full text.

Repeated mentions of the same work were consolidated. For an edited collection, the absent parent volume covers the individual chapter records listed in the older table of contents; those chapters are not counted again as separate missing files.
...
| ID | Reference | What the older control record actually establishes | Local status |
|---|---|---|---|
| MF-001 | Christian Wildhagen, *Die Achte Symphonie von Gustav Mahler: Konzeption einer universalen Symphonik* (2000) | Metadata; 481-page monograph | MISSING FULL TEXT |
| MF-002 | Christian Wildhagen, “Ahnung des Absoluten: Die Achte Symphonie,” in Revers/Korte (eds.), *Gustav Mahler: Interpretationen seiner Werke*, vol. 2 (2011), pp. 141–202 | Metadata and pagination | MISSING FULL TEXT |
| MF-003 | Christian Wildhagen, “The ‘greatest’ and the ‘most personal’: the Eighth Symphony and Das Lied von der Erde,” in *The Cambridge Companion to Mahler* (2007), pp. 128–142 | Metadata plus publisher summary/abstract | MISSING FULL TEXT |
| MF-004 | John Williamson, “The Eighth Symphony,” in *The Mahler Companion* (1999), pp. 407–421 | Metadata/TOC only | MISSING FULL TEXT |
| MF-005 | Donald Mitchell, *Gustav Mahler: Songs and Symphonies of Life and Death* (1985/86; 2002 ed.) | Metadata/TOC; Mahler VIII sections identified | MISSING FULL TEXT |
| MF-006 | Constantin Floros, *Gustav Mahler: The Symphonies*, “The Eighth Symphony” and Part II section | Metadata/TOC only | MISSING FULL TEXT |
| MF-007 | Henry-Louis de La Grange, “The Eighth: Exception or Crowning Achievement?” in *A “Mass” for the Masses* (1992), pp. 131–144 | Metadata only; parent volume also absent | MISSING FULL TEXT |
| MF-008 | Charles Andersen, *Form and Structure in Part II of Gustav Mahler's Symphony No. 8 Using Kofi Agawu's Paradigmatic Analysis* (DMA, 2025) | Metadata and abstract; older note marks repository full text as open | MISSING LOCAL FULL TEXT |
| MF-009 | Richard Specht, *Gustav Mahler's VIII. Symphonie: Thematische Analyse* (1912) | Metadata; older note identifies an open historical scan | MISSING LOCAL FULL TEXT |
...
| MF-027 | Carl E. Schorske, *Fin-de-Siècle Vienna: Politics and Culture* (1980) | Bibliographic recommendation | MISSING FULL TEXT |
...
| ID | Reference | Older-record status | Local status |
|---|---|---|---|
...
| ID | Reference | Correct evidentiary role | Local status |
|---|---|---|---|
| MF-035 | Hans-Joachim Hahn, “Hermann Hesse's Goethe,” in *A Companion to the Works of Hermann Hesse* (2013) | Hesse reception/context; not Mahler influence evidence | MISSING FULL TEXT |
| MF-036 | Volker Michels, “Hermann Hesse and Psychoanalysis,” in the same companion, pp. 323–344 | Hesse's psychoanalytic context; not Mahler influence evidence | MISSING FULL TEXT |
| MF-037 | C. G. Jung, *Psychologische Typen* (1921) | Primary source for Jung's later theory only; postdates composition (1906) and premiere (1910) | MISSING LOCAL FULL TEXT |

The file `research_control_original/03_Friend_TXT_Critical_Appraisal_v1.md` is a non-scholarly project note, not a full-text source. Its Hesse/Jung proposals remain comparative and cannot document Mahler's 1906 intellectual sources.

## E. Mahler-specific primary and near-contemporary evidence absent locally

| ID | Reference | Older-record status | Local status |
|---|---|---|---|
| MF-038 | Mahler, Symphony No. 8 autograph fair copy, Bayerische Staatsbibliothek Mus.ms. 13719 | Archive/catalogue record only | MISSING DIGITAL FACSIMILE |
| MF-039 | Mahler, *Achte Symphonie*, 1911 reduced score with handwritten annotations, Universal Edition | Archive/catalogue record only | MISSING DIGITAL COPY |
| MF-040 | Programme for the Munich world premiere, 12–13 September 1910 | Older note marks an open digital primary source | MISSING LOCAL FILE |
| MF-041 | Richard Specht's 1912 thematic analysis | See MF-009 | MISSING LOCAL FILE |
| MF-042 | Public-domain historical German scan of *Faust II* listed in the download manifest | Alternate primary-text manifestation | MISSING LOCAL FILE, but the German literary work is represented by SRC-003 |

No Mahler score, compositional draft, letter edition, premiere programme, contemporary review, or other Mahler-specific primary document is currently in `sources_raw/`. Claims about chronology, orchestration revisions, intended meaning, performer numbers, premiere reception, or Mahler's own terminology therefore require acquisition or citation outside this local corpus.
